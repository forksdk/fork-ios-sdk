...
public struct WorkoutRoute: Identifiable, Sample {
    ...
    init(sample: HKWorkoutRoute, routes: [Route]) {
        ...
        self.serialized = sample.serialize(routes: routes)
    }
}
// MARK: - Payload
@available(iOS 11.0, *)
extension WorkoutRoute.Location: ForkPayload {
...
// MARK: - Payload
@available(iOS 11.0, *)
extension WorkoutRoute: ForkPayload {
...
// MARK: - Payload
@available(iOS 11.0, *)
extension WorkoutRoute.Serialized: ForkPayload {
    public static func make(from dictionary: [String: Any]) throws -> WorkoutRoute.Serialized {
        guard
        ...
        return WorkoutRoute.Serialized(
            count: count,
...
// MARK: - Payload
@available(iOS 11.0, *)
extension WorkoutRoute.Route: ForkPayload {
