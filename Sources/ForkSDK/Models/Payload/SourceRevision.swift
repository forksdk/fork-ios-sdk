...
// MARK: - ForkOriginal
extension SourceRevision: ForkOriginal {
    func asOriginal() throws -> HKSourceRevision {
        if #available(iOS 11.0, *) {
            ...
            throw ForkError.notAvailable(
                "ForkError is not available for the current iOS"
            )
        }
    }
}
...
// MARK: - Payload
extension SourceRevision.OperatingSystem: ForkPayload {
...
// MARK: - Payload
extension SourceRevision: ForkPayload {
    public static func make(
        from dictionary: [String: Any]
